...
func NewPostgresEngine(logger lager.Logger, group string) *PostgresEngine {
...
func (d *PostgresEngine) CreateUser(bindingID, dbname string) (username, password string, err error) {
	...
	grantPrivilegesStatement := fmt.Sprintf("grant % to %s", "rds_broker", username)
...
func (d *PostgresEngine) ensureGroup() error {
